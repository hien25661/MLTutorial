...
We have an image (referred to as the parent image) that contains multiple frames, which are individual images. We need to extract these frames from the parent image without knowing the coordinates of these frames.![](Aspose.Words.9422deee-3c43-4c28-bb39-7d967de9927f.001.jpeg)![](Aspose.Words.9422deee-3c43-4c28-bb39-7d967de9927f.002.jpeg)

` `![](Aspose.Words.9422deee-3c43-4c28-bb39-7d967de9927f.003.png)
...
1. Configure the annotation format: Choose PascalVOC
...
1. Upload your images: In your project, click on the "Upload" button to add your images.![](Aspose.Words.9422deee-3c43-4c28-bb39-7d967de9927f.007.png)
...
1. Download Dataset![](Aspose.Words.9422deee-3c43-4c28-bb39-7d967de9927f.013.png)
...
1. Upload Dataset to Google Driver for Training Process![](Aspose.Words.9422deee-3c43-4c28-bb39-7d967de9927f.017.png)
...
1. Sign in with Google: Click on the "Sign in" button in the top-right corner of the page and sign in with your Google account. This step is necessary to save your notebooks to Google Drive and access other Google services.
1. Create a new notebook: On the Colab home page, click on the "New Notebook" button. A new notebook will be created, and you will see an empty code cell.
...
1. Create a new notebook: On the Colab home page, click on the "New Notebook" button. A new notebook will be created, and you will see an empty code cell.
1. Please check this link to see the configuration of Colab Notebook: <https://github.com/hien25661/MLTutorial/blob/main/YoloTranning.ipynb>
...
model = torch.hub.load('ultralytics/yolov5', 'custom', path='best.pt', force\_reload=True)  # local model
